...
> Hello Rails is a just a simple application built using Ruby on Rails to display the "Hello World" message. 
...
### Install
    ...
    git clone https://github.com/Theophileaseh/Hello-Rails-App.git
